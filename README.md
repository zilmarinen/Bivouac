...
```swift
.package(url: "https://github.com/zilmarinen/Bivouac.git", branch: "main"),
```
...
The Bivouac framework is primarily the work of [Zack Brown](https://github.com/zilmarinen).
