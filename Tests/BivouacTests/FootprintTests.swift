...
final class FootprintTests: XCTestCase {
    ...
    func testPointyFootprintTranslation() throws {
        ...
        XCTAssertEqual(footprint.coordinates, translatedCoordinates)
    }
    ...
    func testPointyFootprintRotation() throws {
        ...
        XCTAssertEqual(rightRotation.coordinates, rightCoordinates)
        XCTAssertEqual(inverseRotation.coordinates, rightCoordinates)
    }
    ...
    func testPointyFootprintTranslationAndRotation() throws {
        ...
        XCTAssertEqual(rotatedFootprint.coordinates, translatedAndRotatedCoordinates)
    }
